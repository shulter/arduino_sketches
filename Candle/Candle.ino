#define FLICKER_LED_PIN 3
/* 
// the start of the flicker (low)
static int flicker_low_min = 30;
static int flicker_low_max = 50;
 
// the end value of the flicker (high)
static int flicker_high_min = 40;
static int flicker_high_max = 60;
*/
// the start of the flicker (low)
static int flicker_low_min = 10;
static int flicker_low_max = 50;
 
// the end value of the flicker (high)
static int flicker_high_min = 20;
static int flicker_high_max = 60;
...
static int flicker_hold_max = 70; // milliseconds
 
// delay after each low-high-low cycle
// low->high->low |flicker_pause| low->high...
static int flicker_pause_min = 200; // milliseconds
static int flicker_pause_max = 3800;  // milliseconds
